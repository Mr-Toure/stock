    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right m-4">
                <a class="btn btn-success" href="{{ route('users.create') }}"><i class="fa fa-plus"></i>Utilisateur</a>
            </div>
            @role('Super-Admin')
            <div class="pull-right m-4">
                <a class="btn btn-success" href="{{ route('roles.index') }}"><i class="fa fa-plus"></i>Gestion des roles</a>
            </div>
            @endrole
        </div>
    </div>
